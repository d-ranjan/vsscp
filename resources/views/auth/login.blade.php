<x-app-layout>
    <div class="flex flex-col items-center">
        ...
        <div class="p-6 h-54 sm:w-96 text-gray-900 my-2 bg-white rounded-lg shadow-sm dark:bg-slate-800">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div>
                    ...
                    <x-text-input id="phone_number" class="block mt-1 w-full" type="tel" pattern="[1-9][0-9]{9}"
