...
<div class="flex flex-wrap items-center">
    <a href="{{ route($route) }}" {{ $attributes->merge(['class' => 'bg-green-500 text-white text-sm uppercase py-2 px-4 flex items-center rounded']) }}>
        ...
        <span class="ml-2 text-xs font-semibold">{{ $slot }}</span>
    </a>
</div>