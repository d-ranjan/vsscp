<x-app-layout>
    <div class="mx-2 my-4 max-w-lg bg-white overflow-hidden shadow-sm rounded-lg dark:bg-gray-800">
        <div class="flex items-center justify-between p-6 pb-3">
            <h2 class="text-gray-700 uppercase font-bold dark:text-white">Add New Teacher</h2>
        ...
        @endif
        <form action="{{ route('teacher.store') }}" method="POST" class="w-full max-w-xl px-12 pb-6"
            ...
            <div class="my-2">
                ...
                <x-text-input id="phone_number" class="block mt-1 w-full" type="tel" pattern="[0-9]{10}"
                    maxlength="10" minlength="10" name="phone_number" :value="old('phone_number')" required
            ...
            <div class="my-2">
                ...
                <x-text-input id="photo_left" class="block mt-1 w-full" type="file" name="photo_left" required />
            </div>
            ...
            <div class="my-2">
                ...
                <x-text-input id="photo_right" class="block mt-1 w-full" type="file" name="photo_right" required />
            </div>
