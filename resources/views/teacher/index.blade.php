<x-app-layout>
    <div class="mt-14 max-w-2xl mx-auto bg-white overflow-hidden shadow-sm rounded-lg">
            ...
            <div class="mt-2 border rounded-lg overflow-x-auto dark:border-gray-700">
                <table class="text-sm text-white text-center shadow-md dark:text-gray-400">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td scope="row" class="w-4/12 px-1 py-1 text-sm font-semibold text-gray-600 tracking-tight whitespace-nowrap capitalize">
                            {{ $teacher->name }}
                        </td>
                        ...
                        <td class="px-1 py-1">
                            <div class="flex items-center justify-center">
                                <a href="{{ route('teacher.edit', $teacher->id) }}" class="mx-1 bg-green-600 p-2 border-b rounded-sm" title="Edit">
                                ...
                                <a href="{{ route('teacher.destroy', $teacher->id) }}" class="mx-1 bg-red-600 p-2 border-b rounded-sm" title="Delete">
